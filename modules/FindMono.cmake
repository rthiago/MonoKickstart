...
ELSE(MONO_ONLY_LIBRARIES_REQUIRED)
  ...
  MESSAGE(STATUS "${MONO_EXECUTABLE} ${MCS_EXECUTABLE} ${GACUTIL_EXECUTABLE}")

  IF(MONO_EXECUTABLE AND MCS_EXECUTABLE AND GACUTIL_EXECUTABLE)
    SET(MONO_LOOK_FOR_LIBRARIES TRUE)
  ELSE(MONO_EXECUTABLE AND MCS_EXECUTABLE AND GACUTIL_EXECUTABLE)
